...
TEMPLATES = {file_object.name: file_object for file_object in TEMPLATE_DIR_OBJECT.iterdir()}

# The absolute filenames of all resource template files
TEMPLATE_FILE_NAMES = [os.path.join(TEMPLATE_DIR_PATH, template_filename) for template_filename in TEMPLATES.keys()]
